...
This program is a program that is a task manager. 
You can either create a new file to save to or write from an existing file. 
It is simple to use so it doesn't asbtract from the simplicity of doing tasks. 
...
* [ ] Add more fields to the struct like dates and urgency level. 
* [ ] Do some more UI style changes that make it more User freindly.
* [ ] Add a delete task button or make a seperate storage / display for tasks that are done. 


Videos whatched
https://www.youtube.com/watch?v=meEXag1XCFw
